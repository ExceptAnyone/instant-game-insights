      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-bold text-white mb-6">AI 게임 코치</h1>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              인공지능이 당신의 게임 플레이를 실시간으로 분석하고, 개인 맞춤형
              피드백을 제공하여 더 나은 플레이어가 될 수 있도록 도와드립니다.
            </p>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300 mb-4">
                게임 중 발생하는 상황에 대한 즉각적인 피드백을 통해 실력 향상을
                도와드립니다.
              </p>
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300 mb-4">
                개인의 플레이 스타일을 분석하여 약점을 보완하고 강점을 강화할 수
                있도록 맞춤형 정보를 제공합니다.
              </p>
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300 mb-4">
                다양한 게임 상황을 시뮬레이션하여 실제 게임과 유사한 환경에서
                연습할 수 있습니다.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="bg-slate-800/50 border-slate-700 p-6">
                ...
                <p className="text-gray-300">
                  게임 플레이 데이터를 수집하여 AI 모델이 분석할 수 있도록
                  준비합니다.
                </p>
              </Card>
              ...
              <Card className="bg-slate-800/50 border-slate-700 p-6">
                ...
                <p className="text-gray-300">
                  AI 모델이 수집된 데이터를 분석하여 게임 플레이의 강점과 약점을
                  파악합니다.
                </p>
              </Card>
              ...
              <Card className="bg-slate-800/50 border-slate-700 p-6">
                ...
                <p className="text-gray-300">
                  분석 결과를 바탕으로 개인 맞춤형 피드백을 제공하여 실력 향상을
                  위한 가이드라인을 제시합니다.
                </p>
              </Card>
              ...
              <Card className="bg-slate-800/50 border-slate-700 p-6">
                ...
                <p className="text-gray-300">
                  피드백을 바탕으로 꾸준히 연습하고 실력을 향상시켜 더 나은
                  플레이어가 될 수 있습니다.
                </p>
              </Card>
            </div>
